...
|---|---|---|---|
| **0 — NEXT BUILD (Opus 5 ONLY, owner order)** | CON-1: one door for adding a person — Add Customer tile retired, guided flow gains TYPE step + queues add_contact, plain Approve honours the requested type, customer sub-categories in-flow. Spec FULLY LOCKED. | **Agent (Opus 5)** | `telegram-ops-bot/specs/CON-1_SINGLE_PERSON_DOOR.md` |
