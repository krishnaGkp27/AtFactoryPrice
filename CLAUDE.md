...
- Reports: `cks:` `lpk:` `svr:` `inv:` `sr:`/`srg:` `mdo:` `sfs:` (SFS-1 🏬 Store Sales: `w:<i>` place · `d:<i>` day · `pg:<n>` · `back` · `close`)
